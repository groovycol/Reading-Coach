...
class FlaskTestsDatabase(unittest.TestCase):
    ...
    def test_registration_process(self):
        ...
        result = self.client.post("/register_process",
                                  data={"coach_phone": "510-658-1353", "password": "MyPassword", "sms_option": "no", "first_name": "Geraldo", "admin_id": 1, "add_reader": "Julia", "admin_id2": 2, "email": "mrhooper@muppetmail.com"},
                                  follow_redirects=True)
    ...
    def test_registration_process_dupe(self):
        ...
        result = self.client.post("/register_process",
                                  data={"coach_phone": "510-384-8508", "password": "MyPassword", "sms_option": "no", "first_name": "Geraldo", "admin_id": 1, "add_reader": "Julia", "admin_id2": 2, "email": "mrhooper@muppetmail.com"},
                                  follow_redirects=True)
